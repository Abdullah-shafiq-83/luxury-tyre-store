...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-background min-h-[88vh] flex items-center">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_25%_55%,rgba(165,29,45,0.25),transparent_60%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_20%,rgba(210,36,58,0.10),transparent_55%)]" />
      ...
      <div className="pointer-events-none absolute bottom-0 right-0 w-[380px] h-[380px] rounded-full bg-primary-glow/12 blur-[110px] animate-pulse-glow" style={{ animationDelay: "2s" }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-20 md:py-32 grid md:grid-cols-2 gap-12 items-center w-full">
        <motion.div
